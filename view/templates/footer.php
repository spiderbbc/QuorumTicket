<!-- Bootstrap core JavaScript
	    ...
	    <script src="/QTelecom/static/js/bootstrap.min.js"></script>
	    <!-- IE10 viewport hack for Surface/desktop Windows 8 bug -->
	    <script src="/QTelecom/static/js/ie10-viewport-bug-workaround.js"></script>

		<!-- jQuery -->
		<script src="/QTelecom/static/js/jquery.js"></script>
